...
/**
 * Description of MnoSoaBaseTransformer
 *
 * @author root
 */
class MnoSoaTransformer {
    public static function transformCountryNameToISO3166_2($country_name) {
	switch ($country_name) {
    ...
    public static function transformISO3166_2ToCountryName($iso3166_2) {
	switch($iso3166_2) {
